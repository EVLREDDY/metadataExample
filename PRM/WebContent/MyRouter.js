...
jQuery.sap.declare("com.ril.PRMS.MyRouter");

sap.ui.core.routing.Router.extend("com.ril.PRMS.MyRouter", {
	...
	myNavBack : function(sRoute, MasterDetailata) {
		...
		if (sPreviousHash !== undefined) {
			...
			this.navTo(sRoute, MasterDetailata, bReplace);
		}
	},
